...
if __name__ == '__main__':
    ...
    parser.add_argument('--generate-hyperlinks', help="Make techniques hyperlinks in a note file", action="store_true")
    parser.add_argument('--path', help="Filepath to the note to edit")
    ...
    parser.get_data()
    print(args.generate_hyperlinks)
    if args.generate_hyperlinks:
        if args.path:
            if os.path.isfile(args.path):
                ...
                print("You have not provided a valid file path")
        else:
